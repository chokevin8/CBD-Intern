...
#create design matrix for a specific phenotype. Let's choose Male vs Female:
#create factors with two levels male and female, and then design a matrix with 1's and 
# 0's for male and female
Group <- factor(Clinical$Gender, levels = c("MALE","FEMALE"))
